...
3. Session marker (conditional): if no capture registered candidates this session, the session was marked processed with `paput_mark_processed_sessions` (or was already marked, or you are a spawned agent and skipped it).
