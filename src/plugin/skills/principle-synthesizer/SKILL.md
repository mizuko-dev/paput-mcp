...
2. Read the bodies of the memos you plan to cluster with `paput_search_memo` (pass their IDs in `ids`; index first, fetch on demand — do not bulk-fetch everything).
